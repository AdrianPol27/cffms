<?php
  ...
  if (isset($_GET["plu_desc"])) {
		$PLUDescription = $_GET["plu_desc"];
	}

	// If user is not signed in
	$globalFacade->isSignedIn($userId);

  if (isset($_POST["update_plu"])) {
    $id = $_POST["id"];
    ...
    if (empty($PLUNum)) {
      ...
      $updatePLU = $PLUFacade->updatePLU($PLUId, $PLUNum, $PLUDescription, $updatedBy, $updatedOn, $id);
      if ($updatePLU) {
        header("Location: plu.php?update_plu=PLU has been updated successfully!");
      }
    }
  }
      ...
      <div class="content-wrapper">
              ...
              <div class="d-flex align-items-end flex-wrap">
                <div class="me-md-3 me-xl-5">
                  ...
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">Update PLU</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 stretch-card">
            <div class="card">
              <div class="card-body">
                <form class="forms-sample" action="update-plu.php" method="post">
                  <?php include('errors.php'); ?>
                  <div class="form-group">
                    <label for="pluNum">PLU #</label>
                    <input type="text" class="form-control" id="pluNum" placeholder="Enter PLU #" name="plu_num" value="<?= $PLUNum?>">
                  </div>
                  <div class="form-group">
                    <label for="pluDescription">PLU Description</label>
                    <input type="text" class="form-control" id="pluDescription" placeholder="Enter PLU Description" name="plu_description" value="<?= $PLUDescription?>">
                  </div>
                  <button type="submit" class="btn btn-success me-2" name="update_plu">Update PLU</button>
